...
public class Test_120 extends BaseClass{
	
	@Test
	void TC_120() throws Exception
	{
		try {
			test = extent.createTest("Verify The Product Can Be Added To Compare From Product Page");
			Login();
